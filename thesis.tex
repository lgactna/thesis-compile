...
\usepackage{listings}
\usepackage{fontspec} % Use fontspec to load system fonts
\setmonofont{Inconsolata} % Set the monospaced font to Inconsolata
...
\lstdefinestyle{mystyle}{
    ...
    basicstyle=\ttfamily\footnotesize\setstretch{1}\fontspec{Inconsolata}, 
