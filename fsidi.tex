...
\title{AKF: A modern synthesis framework for building datasets in digital forensics
    ...
    \footnote{The authors acknowledge the use of Grammarly and ChatGPT in making grammar and clarity improvements during proofreading.}
}
...
for academic conferences \cite{woodsCreatingRealisticCorpora2011}.
...
public registry \cite{hashicorpHashiCorpCloudPlatform}. When
