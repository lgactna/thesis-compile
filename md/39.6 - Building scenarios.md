...
Consider the following declarative SFX code taken from Russell et al. [@russellForensicImageDescription2012]:
...
The same might be expressed in ForTrace [@gobelForTraceHolisticForensic2022] as the following, excluding additional code required for ground truth and disk image generation:
