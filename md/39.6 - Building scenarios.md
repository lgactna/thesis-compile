...
This information is sufficient for an LLM to "understand" the AKF syntax, such that it is able to generate its own declarative scripts. Such details could be automatically provided as context to an LLM through automatically generated documentation, such as the contents of docstrings and Pydantic model schemas.
