...
\subsection{4.2 - Agentless artifact
generation}\label{agentless-artifact-generation}

\subsubsection{4.2.1 - Hypervisor
...
\subsubsection{4.2.2 - Management utilities}\label{management-utilities}
...
\subsubsection{4.2.3 - AKF agentless
...
\section{4.3 - Agent-based artifact
...
\subsubsection{4.3.1 - Analysis of the ForTrace
...
\subsubsection{4.3.2 - The AKF agent}\label{the-akf-agent}
...
\subsection{4.4 - Physical artifact
generation}\label{physical-artifact-generation}

\subsubsection{4.4.1 - Overview}\label{overview-1}
