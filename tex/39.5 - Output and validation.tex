...
\subsection{Core outputs}\label{core-outputs}

\subsubsection{Extracting datasets}\label{extracting-datasets}

\subsubsection{Distribution and
storage}\label{distribution-and-storage}

\subsection{Metadata and ground
...
\subsubsection{CASE integration in
