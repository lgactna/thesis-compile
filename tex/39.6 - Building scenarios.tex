...
\subsection{6.1 - Background}\label{background}
...
\subsection{6.2 - Setup and imperative
...
\subsection{6.3 - Declarative usage}\label{declarative-usage}

\subsubsection{6.3.1 - Overview}\label{overview}

\subsubsection{6.3.2 - The AKF declarative
syntax}\label{the-akf-declarative-syntax}

\subsection{6.4 - Using generative AI for individual
...
\subsection*{6.5 - Using LLMs for high-level
scenarios}\label{using-llms-for-high-level-scenarios}
\addcontentsline{toc}{subsection}{6.5 - Using LLMs for high-level
scenarios}
